...
const pageData = {
  title: "5.2 적마도사 BiS 가이드",
  description: "파이널 판타지 14 패치 5.2 적마도사 BiS 가이드.",
};
...
const gearSets = [
  {
    ...
    dialog: {
      intro:
        "글로벌 쿨다운 2.5초 캐스터 호환 장비 세트. 장비 마테리아 세팅이 흑마도사/소환사 BiS와 호환됨.",
      gears: [
        {
          itemId: "edenchoirRapier",
              ...
              <Grid container direction="column" spacing={5}>
                ...
                <Grid item>
                  <Typography variant="body1">
                    패치 5.2 기준 적마도사의 Best-in-Slot 장비 세트 목록입니다.
