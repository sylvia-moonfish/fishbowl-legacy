...
const pageData = {
  title: "5.2 소환사 BiS 가이드",
  description: "파이널 판타지 14 패치 5.2 소환사 BiS 가이드.",
};

const gearSets = [
  {
    type: "5.2bis",
    description: "글쿨 2.5초 캐스터 호환 세트.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    dialog: {
      intro:
        "글로벌 쿨다운 2.5초 캐스터 호환 장비 세트. 장비 마테리아 세팅이 흑마도사/적마도사 BiS와 호환됨. 느린 마시를 선호할 경우 추천.",
      gears: [
        {
          itemId: "edenchoirIndex",
        ...
        {
          itemId: "augmentedCrystariumEarringsOfCasting",
          materiaIds: ["dh8", "dh8"],
        },
        {
  ...
  {
    type: "5.2bis",
    description: "글쿨 2.48초 캐스터 호환 세트.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    dialog: {
      intro:
        "글로벌 쿨다운 2.48초 캐스터 호환 장비 세트. 장비 마테리아 세팅이 흑마도사/적마도사 BiS와 호환됨.",
      gears: [
        {
          itemId: "edenchoirIndex",
          materiaIds: ["dh8", "dh8"],
  ...
  },
  {
    ...
    ch: 0,
    dialog: {
      intro: "글로벌 쿨다운 2.5초 절 알렉산더용 장비 세트.",
      gears: [
        {
          itemId: "bookOfGrace",
          materiaIds: ["dh8", "dh8"],
  ...
  },
  {
    ...
    ch: 0,
    dialog: {
      intro: "글로벌 쿨다운 2.48초 절 알렉산더용 장비 세트.",
      gears: [
        {
          itemId: "bookOfGrace",
          materiaIds: ["dh8", "dh8"],
              ...
              <Grid container direction="column" spacing={5}>
                ...
                <Grid item>
                  <Typography variant="body1">
                    패치 5.2 기준 소환사의 Best-in-Slot 장비 세트 목록입니다.
