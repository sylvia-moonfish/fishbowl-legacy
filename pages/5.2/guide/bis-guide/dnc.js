...
const pageData = {
  title: "5.2 무도가 BiS 가이드",
  description: "파이널 판타지 14 패치 5.2 무도가 BiS 가이드.",
};

const gearSets = [
  {
    type: "5.2bis",
    description: "글쿨 2.5초 추천 세트.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    ch: 0,
    dialog: {
      intro: "무도가 글쿨 2.5초 추천 세트.",
      gears: [
        {
          itemId: "edenchoirChakrams",
          materiaIds: ["dh8", "dh8"],
        },
        {
              ...
              <Grid container direction="column" spacing={5}>
                ...
                <Grid item>
                  <Typography variant="body1">
                    패치 5.2 기준 무도가의 Best-in-Slot 장비 세트 목록입니다.
